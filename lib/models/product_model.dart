class ProductModel {
  ...
  static List<ProductModel> dummyProducts = [
    ...
    ProductModel(
      ...
      stock: 90,
      description:
          'Tangy and fresh lemons, perfect for drinks and cooking.',
    ...
    ProductModel(
      ...
      stock: 80,
      description:
          'Fresh green spinach leaves, washed and ready to cook.',
    ...
    ProductModel(
      ...
      stock: 100,
      description:
          'Spicy green chilies for authentic Indian cooking.',
    ...
    ProductModel(
      ...
      stock: 55,
      description:
          'Fresh lady fingers, tender and perfect for stir-fry.',
    ...
    ProductModel(
      ...
      stock: 100,
      description:
          'Classic Coca-Cola soft drink, chilled and refreshing.',
    ...
    ProductModel(
      ...
      stock: 200,
      description:
          '2-minute Maggie noodles, everyone\'s favorite snack.',
    ...
    ProductModel(
      ...
      stock: 70,
      description:
          'Pure gram flour for making pakoras and sweets.',
    ...
    ProductModel(
      ...
      stock: 30,
      description:
          'Premium California almonds, crunchy and healthy.',
    ...
    ProductModel(
      ...
      stock: 20,
      description:
          'Assorted dry fruits pack, a healthy snack option.',
    ...
    ProductModel(
      ...
      stock: 65,
      description:
          'Premium quality toor dal, essential for daily cooking.',
    ...
    ProductModel(
      ...
      stock: 55,
      description:
          'Yellow moong dal, great for light and healthy meals.',
